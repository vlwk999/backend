...
public class Lottery {
    ...
    public void lotteryNum() {
        ...
        String format_time1 = format1.format(time.getTime());//현재시간을 format1 형식에 맞추어  time1에 저장
    ...
    public void result(Membership m, Purchase p ){
        ...
        if(p.customerNum.equals(randomNum)){
            ...
            System.out.println("[INFO] " + m.name + "님의 로또번호는 " + p.customerNum + "입니다.");
            System.out.println("[INFO] 이번 로또 번호는 " + randomNum + "입니다.");
            System.out.println("[INFO] 아쉽게도 낙첨입니다." + m.name + "님 " +"다음 기회를 노려보세요~(찡긋)");
        }
            System.out.println("\n=================================================================\n");
