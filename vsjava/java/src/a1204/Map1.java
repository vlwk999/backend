...
public class Map1 {
    public static void main(String[] args) {
        ...
        updateStudent(studentMap,1,"승우", 31);

        //학생한명 보여주기 key(3)
        System.out.println("\n 특정키 (3)의 Student 정보 읽기");
        Student s = readStudent(studentMap,3);
        System.out.println(s != null? s : "찾는 학생이 없어요");
      

        //학생 삭제
        System.out.println(" \n 특정키 (2)의 Student 정보 수정");
    ...
    private static void deleteStudent(Map<Integer,Student> studentMap, int key){
        if(studentMap.containsKey(key)){
            ...
            System.out.println("학생 삭제" + removStudent); //삭제된 학생을 출력
        }else{
