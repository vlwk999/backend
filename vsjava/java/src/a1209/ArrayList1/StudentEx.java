        ...
        while(true){
            ...
            switch (choice) {
                case 1:
                    ...
                    // 방법 1 -> 선생님은 방법1을 더 추천한다고 함
                    System.out.print("이름을 입력하세요 >>");
                    String n = scanner.nextLine();
                    System.out.print("나이를 입력하세요 >>");
                    int a = scanner.nextInt(); // 숫자 입력할때 ex) 20 \n(개행문자) 
                    //nextInt 다음에는 꼭 nextLine()을 써주는게 좋음
                ...
                case 3:
                    ...
                    for(Student student : students){
                        if(student.getStudentId().equalsIgnoreCase(updateId)){
                            ...
                            scanner.nextLine(); // Consume newline (줄바꿈?)
                ...
                case 5:
                    ...
                    scanner.close();
                    // System.exit(0);
                    // return; // 현재 메서드 (main) 전체를 종료, 호출된 곳을 제어를 반환
                    run = false;
                    break;
