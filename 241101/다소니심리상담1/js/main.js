$(function(){
   ...
   $(window).scroll(function(){
      ...
      //#s3
      var a1 =  $('.s3_title img').offset().top;//   '/'
      var a2 = $('.s3_title h2').offset().top; // 제목
      var a3 = $('.s3_title p').offset().top; // 내용
      var a4 = $('.s3_table li').offset().top; //사각박스
      console.log(a1, a2, a3, a4);
     ...
     //#s4
    var a1 = $('.s4_title img').offset().top;//   '/'
    var a2 = $('.s4_title h2').offset().top; // 제목
    var a3 = $('.s4_title p').offset().top; // 내용
    var a4 = $('.s4_table li').offset().top; //사각박스
    console.log(a1, a2, a3, a4);
